<body id="xinoro-global-container">
  <div class="text-editor-tools-r1">
    <div class="editor-tools-r2" onclick="setFormat('bold');">
      <img src="vendor/assets/XoheBB/image/B.svg" alt="">
    </div>
    <div class="editor-tools-r2" onclick="setFormat('italic');">
      <img src="vendor/assets/XoheBB/image/I.svg" alt="">
    </div>
    <div class="editor-tools-r2" onclick="setFormat('underline');">
      <img src="vendor/assets/XoheBB/image/U.svg" alt="">
    </div>
    <div class="editor-tools-r2" onclick="setFormat('strikethrough');">
      <img src="vendor/assets/XoheBB/image/S.svg" alt="">
    </div>
    <div class="editor-tools-r2" onclick="setFormat('justifyLeft');">
      <img src="vendor/assets/XoheBB/image/align-left.svg" alt="">
    </div>
    <div class="editor-tools-r2" onclick="setFormat('justifyCenter');">
      <img src="vendor/assets/XoheBB/image/align-center.svg" alt="">
    </div>
    <div class="editor-tools-r2" onclick="setFormat('justifyRight');">
      <img src="vendor/assets/XoheBB/image/align-right.svg" alt="">
    </div>
    <div class="editor-tools-r2" onclick="insertUrl();">
      <img src="vendor/assets/XoheBB/image/link.svg" alt="">
    </div>
    <div class="editor-tools-r2" onclick="$('.text-editor-tools-r1').css('display','none');">
      <b class="close-tools-r2">X</b>
    </div>
  </div>
  <nav>
