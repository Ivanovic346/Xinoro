<div index="text-1" class="xinoro-box">
...
</div><div index="footer-1" class="xinoro-box">
    <footer class="box-footer-1">        
        <div class="container">  
            <div class="row">
                <div class="col-lg-3 mb-3">
                    <div class="logo" id="xinoro_text_ed">Xinoro</div>
                    <div class="caption" id="xinoro_text_ed">Designed and built with all the love in the world by the <a href="#">RetCode</a> team with the help of our contributors.<br><br>Code licensed MIT, docs CC BY 3.0.<br><br>Currently v5.1.3.</div>
                </div>
                <div class="col-6 col-lg-2 offset-lg-1 mb-3">
                    <h5 id="xinoro_text_ed">Links</h5>
                  ...
                  <div class="col-6 col-lg-2 mb-3">
                    <h5 id="xinoro_text_ed">Guides</h5>
                    <ul class="list-unstyled">
                  ...
                  <div class="col-6 col-lg-2 mb-3">
                    <h5 id="xinoro_text_ed">IvanKucnjia</h5>
                    <ul class="list-unstyled">
        ...
        <div class="container">  
            <div class="row">
                ...
                <div class="col-6 col-lg-2 offset-lg-1 mb-3">
                  ...
                  <div class="col-6 col-lg-2 mb-3">
                    <h5 id="xinoro_text_ed">Community</h5>
                    <ul class="list-unstyled">
                      <li class="mb-2"><a href="#">Issues</a></li>
                      <li class="mb-2"><a href="#">Discussions</a></li>
                      <li class="mb-2"><a href="#">Corporate sponsors</a></li>
    ...
    <div id="xinoro_background" image-path="aGVhZGVyLTEvYmctaGVhZGVyLTEucG5n" class="content-first-header_1">
        ...
        <div class="introduction-header-1">
            ...
            <div class="inner second_intro" id="xinoro_text_ed">
                <p>Bring YourmmgasgmkasmgmasLife</p>
            </div>
            <div class="inner third_intro" id="xinoro_text_ed">
                <p>Everything that you dreamed of can be brought to life exactly at the </p>
                <p>moment when you decide to win</p>
    ...
    <footer class="box-footer-1">        
        <div class="container">  
            <div class="row">
                <div class="col-lg-3 mb-3">
                    <div class="logo" id="xinoro_text_ed">asgoro</div>
                    <div class="caption" id="xinoro_text_ed">Designed and built with all the love in the world by the <a href="#">RetCode</a> team with the help of our contributors.<br><br>Code licensed MIT, docs CC BY 3.0.<br><br>Cuhuhhuhhuhhhiuhui.</div>
                </div>
                <div class="col-6 col-lg-2 offset-lg-1 mb-3">
                    <h5 id="xinoro_text_ed">asgks</h5>
                    <ul class="list-unstyled">
                      <li class="mb-2"><a href="#">Home</a></li>
                      <li class="mb-2"><a href="#">Docs</a></li>
                      <li class="mb-2"><a href="#">Examples</a></li>
                  ...
                  <div class="col-6 col-lg-2 mb-3">
                    <h5 id="xinoro_text_ed">asgases</h5>
                    <ul class="list-unstyled">
                      <li class="mb-2"><a href="#">Getting started</a></li>
                      <li class="mb-2"><a href="#">Starter template</a></li>
                      <li class="mb-2"><a href="#">Webpack</a></li>
                  ...
                  <div class="col-6 col-lg-2 mb-3">
                    <h5 id="xinoro_text_ed">asgasg</h5>
                    <ul class="list-unstyled">
                      <li class="mb-2"><a href="#">Issues</a></li>
                      <li class="mb-2"><a href="#">Discussions</a></li>
                      <li class="mb-2"><a href="#">Corporate sponsors</a></li>
    ...
    <div id="xinoro_background" image-path="aGVhZGVyLTEvYmctaGVhZGVyLTEucG5n" class="content-first-header_1">
        ...
        <div class="introduction-header-1">
            ...
            <div class="inner second_intro" id="xinoro_text_ed">
                <p>Bring Yourkgkgkgk Ideas to Life</p>
            </div>
            <div class="inner third_intro" id="xinoro_text_ed">
                <p>Everything that you dreamed of can be brought to life exactly at the </p>
                <p>moment when you decide to win</p>
